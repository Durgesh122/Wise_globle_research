...
const About = () => {
  ...
  <p className="text-lg text-white/90"><Trans i18nKey="pages.About.intro.lead">We prioritize what matters most: clear, practical, and research-backed guidance so you can make confident investment decisions.</Trans></p>
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 mb-10">
        <div className="bg-white/30 rounded-xl p-6 flex-1 text-center">
          <h2 className="text-2xl font-bold mb-2"><Trans i18nKey="pages.About.sections.whoWeAre.title">Who we are</Trans></h2>
          <p className="text-white/80"><Trans i18nKey="pages.About.sections.whoWeAre.desc">A SEBI-registered analyst firm focused on delivering unbiased, actionable market research for Indian exchanges.</Trans></p>
        </div>
        <div className="bg-white/30 rounded-xl p-6 flex-1 text-center">
          <h2 className="text-2xl font-bold mb-2"><Trans i18nKey="pages.About.sections.ourMission.title">Our mission</Trans></h2>
          <p className="text-white/80"><Trans i18nKey="pages.About.sections.ourMission.desc">To empower retail and institutional investors with clear, compliance-aware research and strategies.</Trans></p>
        </div>
        <div className="bg-white/30 rounded-xl p-6 flex-1 text-center">
          <h2 className="text-2xl font-bold mb-2"><Trans i18nKey="pages.About.sections.ourVision.title">Our vision</Trans></h2>
          <p className="text-white/80"><Trans i18nKey="pages.About.sections.ourVision.desc">To become a trusted source of market intelligence for Indian financial participants.</Trans></p>
        </div>
      </div>

      <div className="text-center mb-10">
  <span className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg text-lg font-semibold shadow"><Trans i18nKey="pages.About.contact.cta">Need help?</Trans> <a href="tel:+919977909494" className="underline ml-2" aria-label="Call Wise Global Research">+91 9977909494</a></span>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        {steps.map((step, idx) => (
          <div key={idx} className="bg-white/30 rounded-xl p-6 text-center flex flex-col items-center shadow">
            ...
            <h3 className="text-xl font-bold mb-2"><Trans i18nKey={step.titleKey}>{step.title}</Trans></h3>
            <p className="text-white/80"><Trans i18nKey={step.descKey}>{step.desc}</Trans></p>
          </div>
        ))}
      </div>
    </div>
