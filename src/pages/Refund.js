    ...
    <>
      ...
      >
        <motion.h1
          ...
          variants={fadeIn}
        ><Trans i18nKey="pages.Refund.refund-policy">Refund Policy</Trans></motion.h1>
        <motion.div
        ...
        >
          ...
          <motion.section variants={fadeIn} className="mt-12 text-center">
            ...
            <p className="text-base leading-relaxed mb-4"><Trans i18nKey="pages.Refund.for-any-questions-or-assistance-regardin"><Trans i18nKey="pages.Refund.for-any-questions-or-assistance-regardin-1">For any questions or assistance regarding our refund policy, please contact us at:</Trans></Trans></p>
