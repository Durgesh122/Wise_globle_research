...
const InfinityClub = () => (
  <div className="container mx-auto py-12 px-4 max-w-5xl text-white">
    <h1 className="text-4xl font-extrabold mb-4 text-center text-white">Infinity Club</h1>
    ...
    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white text-center">Pricing Plan For Infinity Club</h2>
      <div className="flex justify-center">
        <div className="border rounded-xl p-6 shadow-md bg-white/30 flex flex-col items-center w-full max-w-md">
          <h3 className="text-xl font-bold mb-2 text-white">Infinity Club</h3>
    ...
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Why Choose Infinity Club?</h2>
