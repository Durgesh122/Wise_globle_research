...
const SmartFuture = () => (
  <div className="container mx-auto py-12 px-4 max-w-5xl text-white">
    <h1 className="text-4xl font-extrabold mb-4 text-center text-white">Smart Future</h1>
    <p className="text-lg mb-6 text-center text-white">
      Smart Future is designed and destined to deliver returns that you deserve. It offers you nearly 2-3 intraday recommendations with good level of accuracy and market return. The recommendations are given in scrip traded on NSE. Our timely generated technical recommendations provide adequate time to enter in trades. Our recommendations are supreme blend of Technical and fundamental research.<br/><br/>
      We have a team of analysts who are specialized in Tracking F&amp;O market and keep a complete track of all the national and international events and Major Sectors and blend it with technical analysis to predict the market moves.<br/><br/>
    ...
    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white">Smart Future Features</h2>
    ...
    <div className="mb-8">
      ...
      <div className="bg-white/10 rounded-lg p-4 text-center text-base text-white font-mono">
        BUY LAURUSLABS ABOVE 758 TGT 761 764 SL 754.50
      </div>
    </div>

    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white">Pricing Plan For Smart Future</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
        <div className="border rounded-xl p-6 shadow-md bg-white/30 flex flex-col items-center">
          <h3 className="text-xl font-bold mb-2 text-white">Smart Future</h3>
    ...
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Why Choose Smart Future?</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white/20 rounded-lg p-6 flex flex-col items-center">
          ...
          <p className="text-white text-center">Hundreds of F&amp;O traders rely on our signals for consistent results.</p>
        </div>
      </div>
    </div>
