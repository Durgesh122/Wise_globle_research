...
const MCXOption = () => (
  <div className="container mx-auto py-12 px-4 max-w-5xl text-white">
    <h1 className="text-4xl font-extrabold mb-4 text-center text-white">MCX Options</h1>
    ...
    <div className="mb-8">
      ...
      <ul className="list-disc pl-6 text-base mb-4 text-white">
        <li>1-2 Intraday/Positional options recommendations in Bullions, Base Metals, and Energy (as per market conditions).</li>
        ...
        <li>Comprehensive analysis of market direction and concise domestic & world market information.</li>
        <li>Recommendations delivered via SMS for instant action.</li>
        <li>Swift, real-time customer support (09:00 AM to 06:00 PM).</li>
      </ul>
      <p className="text-base mb-2 text-white">MCX Options Services are ideal for traders who want detailed technical and fundamental market analysis for options trading in one pack.</p>
    </div>

    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white">Trading Rules Every Options Trader Must Follow</h2>
    ...
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Why Choose MCX Options?</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white/20 rounded-lg p-6 flex flex-col items-center">
          ...
          <p className="text-white text-center">Our team combines technical and fundamental analysis for the most reliable options recommendations.</p>
        </div>
        <div className="bg-white/20 rounded-lg p-6 flex flex-col items-center">
        ...
        <div className="bg-white/20 rounded-lg p-6 flex flex-col items-center">
          ...
          <p className="text-white text-center">Hundreds of commodity options traders rely on our signals for consistent results.</p>
        </div>
      </div>
    </div>
    ...
    <div className="my-12">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-4">
          <h3 className="font-semibold text-white">Q: How will I receive the options recommendations?</h3>
          <p className="text-white">A: All options recommendations are sent via SMS to your registered mobile number.</p>
        </div>
        <div className="mb-4">
