...
const Bullions = () => (
  <div className="container mx-auto py-12 px-4 max-w-5xl text-white">
    <h1 className="text-4xl font-extrabold mb-4 text-center text-white">Bullions</h1>
    ...
    <div className="mb-8">
      ...
      <ul className="list-disc pl-6 text-base mb-4 text-white">
        <li>1-2 Intraday/Positional recommendations in Gold, Silver, and Platinum (as per market conditions).</li>
        ...
        <li>Comprehensive analysis of global and domestic bullion markets.</li>
        <li>Recommendations delivered via SMS for instant action.</li>
        <li>Swift, real-time customer support (09:00 AM to 06:00 PM).</li>
      </ul>
      <p className="text-base mb-2 text-white">Bullions Services are ideal for traders who want detailed technical and fundamental market analysis in one pack.</p>
    </div>
    ...
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Why Choose Bullions?</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white/20 rounded-lg p-6 flex flex-col items-center">
          ...
          <p className="text-white text-center">Hundreds of bullion traders rely on our signals for consistent results.</p>
        </div>
      </div>
    </div>
