...
const SmartOptions = () => (
  <div className="container mx-auto py-12 px-4 max-w-5xl text-white">
    <h1 className="text-4xl font-extrabold mb-4 text-center text-white">Smart Options</h1>
    <p className="text-lg mb-6 text-center text-white">
      Smart Options service is specifically designed for option traders trading who want to take advantage of short term stock price movement. Wise Global Research Analyst provides the recommendations to intraday traders to optimize every market movement. We have a team of analysts who are specialized in Tracking F&amp;O market and keep a complete track of all the national and international events and Major Sectors and blend it with technical analysis to predict the market moves.<br/><br/>
      Our timely generated technical recommendations provide adequate time to enter in trades. Our recommendations are supreme blend of Technical and fundamental research.
    </p>

    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white">Smart Options Features</h2>
      <ul className="list-disc pl-6 text-base mb-4 text-white">
        <li>We provides 2-3 Intraday stock recommendation’s (as per market conditions).</li>
    ...
    <div className="mb-8">
      ...
      <div className="bg-white/10 rounded-lg p-4 text-center text-base text-white font-mono">
        BUY HAL MAR 2600 CE ABOVE 131 TARGET 145 160 STOPLOSS 112
      </div>
    </div>

    <div className="mb-8">
      <h2 className="text-2xl font-bold mb-2 text-white">Pricing Plan For Smart Options</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
        <div className="border rounded-xl p-6 shadow-md bg-white/30 flex flex-col items-center">
          <h3 className="text-xl font-bold mb-2 text-white">Smart Options</h3>
    ...
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Why Choose Smart Options?</h2>
