            ...
            >
              <div style={{ color: '#0b1220' }}>
                ...
                <motion.div className="text-center mb-6" variants={itemVariants}>
                  <h2 className="text-2xl sm:text-3xl font-bold mb-2 text-center" style={{ color: '#6366f1' }}>
                    <Trans i18nKey="pages.InvestorChart.investor-charter">Investor Charter</Trans>
                  </h2>
                  <motion.p variants={itemVariants} className="mt-2 text-xs sm:text-sm md:text-base leading-relaxed">
                ...
                <motion.div className="mb-6" variants={itemVariants}>
                  <div className="bg-white/0 p-6 rounded-xl" style={{ backgroundColor: 'transparent' }}>
                    <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.a-vision-and-mission-statements-for-inve"><Trans i18nKey="pages.InvestorChart.a-vision-and-mission-statements-for-inve-1">A. Vision and Mission Statements for Investors</Trans></Trans></h3>
                    <div className="space-y-4 text-sm sm:text-base leading-relaxed">
                      <div>
                        <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.vision">Vision</Trans></h4>
                        <motion.p variants={itemVariants} style={{ color: '#0b1220' }}>
                      ...
                      <div>
                        <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.mission">Mission</Trans></h4>
                        <motion.p variants={itemVariants} style={{ color: '#0b1220' }}>
                ...
                <motion.div className="mb-6" variants={itemVariants}>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.b-details-of-business-transacted-by-the-"><Trans i18nKey="pages.InvestorChart.b-details-of-business-transacted-by-the--1">B. Details of Business Transacted by the Research Analyst with Respect to the Investors</Trans></Trans></h3>
                  <ul className="list-disc pl-5 mt-2 space-y-2" style={{ color: '#0b1220' }}>
                ...
                <motion.div className="mb-6" variants={itemVariants}>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.c-details-of-services-provided-to-invest"><Trans i18nKey="pages.InvestorChart.c-details-of-services-provided-to-invest-1">C. Details of Services Provided to Investors (No Indicative Timelines)</Trans></Trans></h3>
                  <div className="space-y-4 text-sm sm:text-base leading-relaxed" style={{ color: '#0b1220' }}>
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.onboarding-of-clients">Onboarding of Clients</Trans></h4>
                    ...
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.disclosure-to-clients">Disclosure to Clients</Trans></h4>
                      <ul className="list-disc pl-5 mt-2">
                ...
                <motion.div className="mb-6" variants={itemVariants}>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.d-details-of-grievance-redressal-mechani"><Trans i18nKey="pages.InvestorChart.d-details-of-grievance-redressal-mechani-1">D. Details of Grievance Redressal Mechanism and How to Access It</Trans></Trans></h3>
                  <div className="space-y-3 text-sm sm:text-base leading-relaxed" style={{ color: '#0b1220' }}>
                    ...
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.mode-of-filing-the-complaint-with-resear"><Trans i18nKey="pages.InvestorChart.mode-of-filing-the-complaint-with-resear-1">Mode of Filing the Complaint with Research Analyst</Trans></Trans></h4>
                      <motion.p variants={itemVariants}>
                    ...
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.mode-of-filing-the-complaint-on-scores-o"><Trans i18nKey="pages.InvestorChart.mode-of-filing-the-complaint-on-scores-o-1">Mode of Filing the Complaint on SCORES or with Research Analyst Administration and Supervisory Body (RAASB)</Trans></Trans></h4>
                      <ul className="list-disc pl-5 mt-2 space-y-2">
                        <li>
                          ...
                          <a href="https://scores.sebi.gov.in" className="text-blue-500 hover:underline"> <Trans i18nKey="pages.InvestorChart.https-scores-sebi-gov-in"><Trans i18nKey="pages.InvestorChart.https-scores-sebi-gov-in-1">https://scores.sebi.gov.in</Trans></Trans></a>)
                        </li>
                        <li>
                    ...
                    <p className="font-medium" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.office-of-investor-assistance-and-educat"><Trans i18nKey="pages.InvestorChart.office-of-investor-assistance-and-educat-1">Office of Investor Assistance and Education, Securities and Exchange Board of India, SEBI Bhavan, Plot No.C4-A, ‘G’ Block, Bandra – Kurla Complex, Bandra (E), Mumbai-400051</Trans></Trans></p>
                  </div>
                </motion.div>

                {/* Section E: Rights of Investors */}
                <motion.div className="mb-6" variants={itemVariants}>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.e-rights-of-investors">E. Rights of Investors</Trans></h3>
                  <ul className="list-disc pl-5 mt-2 space-y-2" style={{ color: '#0b1220' }}>
                ...
                <motion.div className="mb-6" variants={itemVariants}>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0b1220' }}><Trans i18nKey="pages.InvestorChart.f-expectations-from-the-investors-respon"><Trans i18nKey="pages.InvestorChart.f-expectations-from-the-investors-respon-1">F. Expectations from the Investors (Responsibilities of Investors)</Trans></Trans></h3>
                  <div className="space-y-4 text-sm sm:text-base leading-relaxed" style={{ color: '#0b1220' }}>
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.do-s">Do’s</Trans></h4>
                      <ul className="list-decimal pl-5 mt-2 space-y-2">
                        ...
                        <li>
                          ...
                          <a href="https://www.sebi.gov.in/sebiweb/other/OtherAction.do?doRecognisedFpi=yes&intmId=14" className="text-blue-500 hover:underline"> <Trans i18nKey="pages.InvestorChart.https-www-sebi-gov-in">https://www.sebi.gov.in</Trans></a>
                        </li>
                    ...
                    <div>
                      <h4 className="text-base font-medium" style={{ color: '#6366f1' }}><Trans i18nKey="pages.InvestorChart.don-ts">Don’ts</Trans></h4>
                      <ul className="list-decimal pl-5 mt-2 space-y-2">
